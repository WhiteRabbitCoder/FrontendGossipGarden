    ...
    with Session(engine) as session:
        ...
        if not species_exists:
            ...
            specie_1 = PlantSpeciesProfileModel(
                ...
                personality='''Habla como una abuela sabia que siempre tiene té listo. Tranquila, paciente, y 
                    le encanta recordar que todo mejora con el tiempo y un poco de sol.''',
